...
const HERO_SCENES_DATA = [{
  badge: '🚀 Future-Ready AI Education',
  line1: 'MASTER AI-POWERED',
  line2: 'CREATIVE SKILLS.',
  sub: 'Learn Graphic Design, Filmmaking, Website Creation, UI/UX Design, and Content Production using the latest AI tools. Industry-focused pre-recorded courses designed for students, freelancers, entrepreneurs, and professionals.'
}, {
  badge: '🎨 AI Graphic Design Mastery',
  line1: 'DESIGN WITH',
  line2: 'AI.',
  sub: 'Create professional logos, branding, social media creatives, advertisements, and marketing assets using modern AI design workflows.',
  ...
  badge: '🎬 AI Filmmaking & Video',
  line1: 'CREATE CINEMATIC',
  line2: 'VIDEOS.',
  sub: 'Learn cinematic storytelling, AI video generation, editing, voiceovers, visual effects, and content production for social media and business.',
  ...
  sub: 'Get instant access to practical AI courses. Master the skills, tools, and strategies needed to lead the next generation of AI-powered businesses and careers.'
}];
const HeroSection = ({
  handleGeneralEnroll,
  navigateToSection,
  ...
  useEffect(() => {
    const isModalActive = !!enrollModal || !!theaterVideo || !!isAdminOpen || !!showIosModal || !!isStudentOpen || !!mobileMenuOpen;
    if (isModalActive) {
      return;
    }
  ...
  }, [activeScene, enrollModal, theaterVideo, isAdminOpen, showIosModal, isStudentOpen, mobileMenuOpen]);
...
const courseList = [{
  ...
  description: 'Learn the core concepts of Artificial Intelligence, understand how AI tools work, and build a strong foundation for advanced creative AI applications.',
  icon: 'cpu',
  colorName: 'cyan',
  colorCode: '#00f0ff',
  ...
  priceAmount: 0,
  tagline: 'Start Your AI Journey for Free',
  fullDescription: 'AI Fundamentals is your free gateway into the world of Artificial Intelligence. This beginner-friendly course covers essential AI concepts, prompt engineering basics, and hands-on practice with popular AI tools. Perfect for students, professionals, and entrepreneurs who want to understand how AI can transform their work and creativity.',
  ...
  description: 'Create professional logos, branding, social media creatives, advertisements, and marketing assets using modern AI design workflows.',
  icon: 'palette',
  colorName: 'emerald',
  colorCode: '#10b981',
  badge: 'Top Seller',
  ...
  fullDescription: 'Master the future of graphic design by combining creativity with powerful AI tools. Learn how to create logos, brand identities, social media campaigns, advertising creatives, product mockups, and marketing materials with professional workflows used by modern designers.',
  ...
  description: 'Learn cinematic storytelling, AI video generation, editing, voiceovers, visual effects, and content production for social media and business.',
  icon: 'film',
  colorName: 'rose',
  colorCode: '#ec4899',
  badge: 'Premium',
  ...
  fullDescription: 'Learn how to produce professional-quality videos using AI-powered workflows. Create commercials, social media content, explainer videos, cinematic trailers, and business promotions with minimal equipment.',
  ...
  description: 'Build professional websites, landing pages, portfolios, and business websites without writing code using AI-powered website builders.',
  icon: 'globe',
  colorName: 'cyan',
  colorCode: '#00f0ff',
  badge: 'Popular',
  ...
  fullDescription: 'Learn how to create modern websites, landing pages, business sites, portfolios, and online stores using AI-powered no-code tools. Perfect for entrepreneurs, freelancers, and designers who want to launch websites quickly.',
  ...
  description: 'Design modern websites and mobile app interfaces using AI-assisted research, wireframing, prototyping, and design systems.',
  icon: 'smartphone',
  colorName: 'violet',
  colorCode: '#a855f7',
  badge: 'New',
  ...
  fullDescription: 'Learn the complete UI/UX design process from research to prototyping while leveraging AI tools to improve productivity and creativity.',
  ...
  fullDescription: 'Master AI-driven content creation for social media, blogs, advertisements, email campaigns, and digital marketing.',
...
const whyChooseUsData = [{
  ...
  desc: 'Access lessons anytime, anywhere. No strict schedules — learn when it works for you.'
}, {
  title: 'Practical Projects',
  desc: 'Build real-world portfolio projects that demonstrate your skills to employers and clients.'
}, {
  title: 'Industry-Relevant Skills',
  desc: 'Learn tools currently used by businesses and agencies worldwide.'
}, {
  title: 'Beginner Friendly',
  desc: 'No prior experience required. Start from scratch and build up your skills step by step.'
}, {
  title: 'Lifetime Access',
  desc: 'Revisit lessons whenever needed. Your course materials never expire.'
}, {
  title: 'Regular Updates',
  desc: 'Stay current with rapidly evolving AI technologies. Course content is updated regularly.'
}];
...
const journeyTimeline = [{
  step: 'Step 1',
  title: 'Enroll',
  desc: 'Secure lifetime access and launch curriculum access key.'
}, {
  step: 'Step 2',
  title: 'Learn AI Tools',
  desc: 'Master prompt setups, assets workflows, and generative systems.'
}, {
  step: 'Step 3',
  title: 'Build Real Projects',
  desc: 'Compile professional mockups, films, and code templates.'
}, {
  step: 'Step 4',
  title: 'Create Portfolio',
  desc: 'Polish a high-end showcase folder to attract employers and clients.'
}, {
  step: 'Step 5',
  title: 'Launch & Scale',
  desc: 'Apply knowledge directly to increase productivity and launch scaling setups.'
}];
const studentTestimonials = [{
  name: 'Arjun Nair',
  role: 'Freelance Designer',
  rating: 5,
  review: 'I was able to start freelancing within two months after completing the AI Graphic Design course. The lessons are practical and easy to follow.',
  avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=150&auto=format&fit=crop',
  project: 'Started freelancing in 2 months'
}, {
  name: 'Sneha Thomas',
  role: 'Business Owner',
  rating: 5,
  review: 'The AI Filmmaking course helped me create professional videos for my business without hiring a production team.',
  avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=150&auto=format&fit=crop',
  project: 'Created professional brand videos'
}, {
  name: 'Muhammed Rafi',
  role: 'Startup Founder',
  rating: 5,
  review: 'I had no coding experience, but the No-Code Website course helped me build my company\'s website in just a few days.',
  avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=150&auto=format&fit=crop',
  project: 'Built company website in days'
}, {
  name: 'Anjali Menon',
  role: 'UI/UX Designer',
  rating: 5,
  review: 'The UI/UX course explained modern design workflows clearly. The AI tools significantly reduced my design time.',
  avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=150&auto=format&fit=crop',
  project: 'Reduced design time by 60%'
}, {
  name: 'Rahul Krishnan',
  role: 'Content Creator',
  rating: 5,
  review: 'Excellent content and well-structured lessons. I especially liked the practical examples and tool demonstrations.',
  avatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=150&auto=format&fit=crop',
  project: 'Improved content workflow'
}];
...
const App = () => {
  ...
  // Firebase Config (Replace these placeholder values with actual Firebase keys if connecting a live Firestore db)
  ...
  const [welcomeEmailBody, setWelcomeEmailBody] = useState('Hi {name},\n\nWelcome to Dxign Learn! 🚀\n\nThank you for completing your registration for the {course} program. We are thrilled to have you join our learning community!\n\nHere is what you can expect:\n* Access to all course lectures and materials.\n* Hands-on projects with real-world case studies.\n* Expert mentor support to guide you at every step.\n\nOur team will reach out to you shortly with your student login and portal access details.\n\nIf you have any questions, feel free to reply directly to this email.\n\nBest regards,\nDxign Learn Team');
  const [welcomeWhatsappBody, setWelcomeWhatsappBody] = useState('Hi {name}! 🎉 Welcome to Dxign Learn! Thank you for completing your registration for the *{course}* program. Your learning journey begins now. Our team will reach out shortly with your portal access details. - Dxign Learn Team');
  ...
  const GOOGLE_SHEET_WEBHOOK_URL = 'https://script.google.com/macros/s/AKfycbx9U6UOWeuAnCkjMswy5XzneNuMynWZjljSJRWjKkZe9DT5aaTl1DawcqscERXg3fHumw/exec'; // Paste your Google Sheet web app URL here
  ...
  useEffect(() => {
    (async () => {
      try {
        const webhookUrl = window.WEBHOOK_URL || 'https://script.google.com/macros/s/AKfycbx9U6UOWeuAnCkjMswy5XzneNuMynWZjljSJRWjKkZe9DT5aaTl1DawcqscERXg3fHumw/exec';
        const res = await fetch(webhookUrl + '?action=getWhatsAppConfig');
        ...
        setWelcomeWhatsappBody(config.whatsappBody || 'Hi {name}! 🎉 Welcome to Dxign Learn! Thank you for completing your registration for the *{course}* program. Your learning journey begins now. To start, open the Dxign Learn Mobile App and log in with your email to receive your OTP. - Dxign Learn Team');
      } catch (_) {}
    })();
  }, []);
  ...
  const handleTestWhatsApp = async () => {
    ...
    try {
      const webhookUrl = window.WEBHOOK_URL || 'https://script.google.com/macros/s/AKfycbx9U6UOWeuAnCkjMswy5XzneNuMynWZjljSJRWjKkZe9DT5aaTl1DawcqscERXg3fHumw/exec';
      const res = await fetch(webhookUrl + '?action=testWhatsApp&phone=' + encodeURIComponent(whatsAppTestPhone.trim()));
      const data = await res.json();
      if (data.status === 'success') {
        setWhatsAppStatus({
          type: 'success',
  ...
  const handleAdminLogin = e => {
    if (e) e.preventDefault();
    const correctPassword = 'DxignAdmin2026';
...
Dxign Learn Team`);
  ...
  const handleRazorpayPay = () => {
    ...
    if (enrollModal.priceAmount === 0) {
      ...
      alert('🎉 Welcome to ' + courseVal + '!\n\nYour free enrollment is confirmed. Check your email for course access details.');
      return;
    }
    const options = {
      key: RAZORPAY_KEY,
  ...
  const handleGeneralEnroll = () => {
    openEnrollModal({
      ...
      description: 'Get immediate lifetime access to all 6 AI courses: AI Fundamentals, Graphic Design, Filmmaking, Website Creation, UI/UX Design, and Content Marketing, including all future updates.',
      icon: 'layers',
      colorName: 'cyan',
      colorCode: '#00f0ff',
      badge: 'Best Value',
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }), "Why AI Now"), /*#__PURE__*/React.createElement("h2", {
  ...
  }, "Artificial intelligence is reshaping every industry \u2014 from design and marketing to filmmaking and web development. Companies are actively seeking professionals who can leverage AI tools to work faster, smarter, and more creatively."), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-400 text-sm md:text-base leading-relaxed font-light mb-8"
  }, "Whether you're a student, freelancer, business owner, or creative professional, learning AI skills today gives you a massive advantage in tomorrow's job market. DXIGN Learn provides the practical training you need to stay ahead."), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm"
  }, ['AI Is Transforming Industries', 'High Demand for AI Skills', 'Future-Proof Your Career', 'Work 10x Faster', 'No Coding Required', 'Start Learning Today'].map((item, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    ...
    className: "w-1.5 h-1.5 bg-brand-cyan rounded-full mr-2"
  }), "Featured Courses"), /*#__PURE__*/React.createElement("h2", {
    className: "text-3xl md:text-5xl font-black uppercase text-white font-heading tracking-tight leading-none"
  ...
  React.createElement("div", {
    ...
    className: "w-1.5 h-1.5 bg-brand-cyan rounded-full mr-2"
  }), "AI Tools Covered"), /*#__PURE__*/React.createElement("h2", {
    className: "text-3xl md:text-5xl font-black uppercase text-white font-heading tracking-tight leading-none"
    ...
    className: "w-1.5 h-1.5 bg-brand-cyan rounded-full mr-2"
  }), "Projects You'll Build"), /*#__PURE__*/React.createElement("h2", {
    className: "text-3xl md:text-5xl font-black uppercase text-white font-heading tracking-tight leading-none"
  ...
  }, /*#__PURE__*/React.createElement("span", null, showAllProjects ? 'Show Less Works' : 'Explore More Works'), /*#__PURE__*/React.createElement("i", {
    ...
    className: "w-1.5 h-1.5 bg-brand-cyan rounded-full mr-2"
  }), "Student Reviews"), /*#__PURE__*/React.createElement("h2", {
    className: "text-3xl md:text-5xl font-black uppercase text-white font-heading tracking-tight leading-none"
    ...
    className: "w-1.5 h-1.5 bg-brand-cyan rounded-full mr-2"
  }), "Why Choose DXIGN Learn"), /*#__PURE__*/React.createElement("h2", {
    className: "text-3xl md:text-5xl font-black uppercase text-white font-heading tracking-tight leading-none"
    ...
    className: "w-1.5 h-1.5 bg-brand-cyan rounded-full mr-2"
  }), "Learning Roadmap"), /*#__PURE__*/React.createElement("h2", {
    className: "text-3xl md:text-5xl font-black uppercase text-white font-heading tracking-tight leading-none"
  ...
  }), "Launch Offer \xB7 Lifetime Access"), /*#__PURE__*/React.createElement("h2", {
  ...
  }, "Join the next generation of creators, entrepreneurs, and professionals using AI to achieve extraordinary results. Get complete lifetime access to all future course modules."), /*#__PURE__*/React.createElement("div", {
    ...
    a: 'No, all courses are designed for beginners. We start from the basics and gradually build up to advanced concepts.'
  }, {
    ...
    a: 'Yes, you will receive a certificate of completion for each course you finish.'
  }, {
    q: 'Can I learn at my own pace?',
    a: 'Absolutely! All lessons are pre-recorded so you can learn whenever and wherever works best for you.'
  }, {
    q: 'What kind of projects will I build?',
    a: 'You\'ll create real-world portfolio projects like logos, brand identities, videos, websites, and UI designs.'
  }, {
    ...
    className: "w-1.5 h-1.5 bg-brand-cyan rounded-full mr-2 animate-pulse"
  }), "24/7 Doubt Support"), /*#__PURE__*/React.createElement("h2", {
  ...
  }, "Stuck on a concept during class? Get real-time help from mentors right when you need it. No waiting, no emails \u2014 just instant answers."), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Unlock Your Future with AI"), /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-gray-500 mt-2 max-w-xl mx-auto"
  }, "Take the first step toward mastering industry-leading AI skills.")), (() => {
    ...
    }, "Select a course"), /*#__PURE__*/React.createElement("option", {
  ...
  }, "Obtecs is an independent education portal. Midjourney, Stable Diffusion, Runway, and ElevenLabs are trademarks of their respective owners.")), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col text-left"
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, "\xA9 2026 Obtecs. All Rights Reserved."), /*#__PURE__*/React.createElement("span", {
    className: "text-gray-600"
  }, "Site inspired by Apple. Engineered using React, CSS, and Tailwind CSS."))), enrollModal && (() => {
  ...
  }, newLectureSaving ? 'Saving...' : editingLecture ? 'Update Lecture & Sync' : 'Save Lecture & Sync'))))))))), activePreviewMedia && /*#__PURE__*/React.createElement("div", {
